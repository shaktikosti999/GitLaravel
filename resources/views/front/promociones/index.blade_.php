								...
								<div class="">
									...
									@if(isset($item->texto_boton))
										<form action="{{$item->link}}" target="{{$item->is_new_tab}}">
											<input type="submit" value="{{$item->texto_boton}}" style="min-width: 7em;padding-left: 5px;padding-right: 5px; font-size: 30px;background-color: red;box-shadow: 1px 1px 1px 1px black;border-radius: 10px;color: white;position: absolute;z-index: 1000;">
										</form>
									@endif

									<h3 style="text-transform: uppercase;"><?php if(isset($item->titulo)){ echo $item->titulo; } ?></h3>
