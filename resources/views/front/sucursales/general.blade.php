				...
				@endif
						<li>
							...
							<div class="section-actions btn-action">
								<a href="http://www.google.com/maps/place/{{ $item->latitud . "," . $item->longitud }}" target="_blank" class="btn btn-red btn-red-small" onclick="dataLayer.push ({ 'event': 'llegaraqui', 'casino': '{{$item->nombre}}' });">
									<i class="ico-human"></i>
