		...
		<script>
			$(function(){
				$('.activo').on('change', function(){
					...
					$.ajax({
						url:'/administrador/estatus/alimento.html',
						type:'POST',
						data:{
							_token:"{{csrf_token()}}",
							id:id
				...
				<div class="panel panel-transparent">
					<div class="panel-heading">
						...
						<div class="pull-right">
							<div class="col-xs-12">
		                    	<a href="{{url('/administrador/agregar/alimento.html')}}" class="btn btn-primary btn-cons"><i class="fa fa-plus"></i> Agregar</a>
			              	</div>
		                </div>
					</div>
										...
										<tr role="row" class="">
											...
											<td class="v-align-middle">
												<div class="btn-group btn-group-justified">
						                            <div class="btn-group">
						                              	<form action="{{url('/administrador/modificar/alimento' . $alimento->id . '.html')}}" method="post">
															{!!csrf_field()!!}
						                            ...
						                            <div class="btn-group">
						                            	<form action="{{url('/administrador/eliminar/alimento' . $alimento->id . '.html')}}" method="post" class="del_element">
															{!!csrf_field()!!}
