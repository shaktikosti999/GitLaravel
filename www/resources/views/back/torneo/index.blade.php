		...
		<script>
			$(function(){
				$('.activo').on('change', function(){
					...
					$.ajax({
						url:'/administrador/estatus/torneo.html',
						type:'POST',
						data:{
							_token:"{{csrf_token()}}",
							id:id
			...
			<!-- START PANEL -->
				<div class="panel panel-transparent">
					<div class="panel-heading">
						<div class="panel-title">Torneos
						</div>
						<div class="pull-right">
							<div class="col-xs-12">
		                    	<a href="{{url('/administrador/agregar/torneo.html')}}" class="btn btn-primary btn-cons"><i class="fa fa-plus"></i> Agregar</a>
			              	</div>
		                </div>
					</div>
					</br>
														...
														<tr role="row" class="">
															...
															<td class="v-align-middle">
																<div class="btn-group btn-group-justified">
										                            ...
										                            <div class="btn-group">
										                              	<form action="{{url('/administrador/modificar/torneo' . $carrera->id . '.html')}}" method="post">
																			{!!csrf_field()!!}
										                            ...
										                            <div class="btn-group">
										                            	<form action="{{url('/administrador/eliminar/torneo' . $carrera->id . '.html')}}" method="post" class="del_element">
																			{!!csrf_field()!!}
