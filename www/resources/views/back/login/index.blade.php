...
<html>
  <head>
    ...
    <meta charset="utf-8" />
    <title>@yield('titulo','Abargon')</title>
          ...
          <div class="pull-bottom sm-pull-bottom">
            <div class="m-b-30 p-r-80 sm-m-t-20 sm-p-r-15 sm-p-b-20 clearfix">
              <div class="col-sm-3 col-md-2 no-padding">
                <img alt="" class="m-t-5" data-src="{{asset('/assets/img/demo/pages_icon.png')}}" data-src-retina="assets/img/demo/pages_icon_2x.png" height="60" src="{{asset('/assets/img/demo/pages_icon.png')}}" width="60">
              </div>
