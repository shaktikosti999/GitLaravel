...
<html>
  <head>
    ...
    <meta charset="utf-8" />
    <title>@yield('titulo','The Anglo | Abarcontent')</title>
    ...
    <nav class="page-sidebar" data-pages="sidebar">
      ...
      <div class="sidebar-menu">
        ...
        <ul class="menu-items">
          ...
          @endif
          <!-- <li class="">
            <a href="{{url('/administrador/usuario.html')}}" class="detailed">
          ...
          <li>
            <a href="javascript:;"><span class="title">Accesos</span>
            <span class=" arrow"></span></a>
            <span class="icon-thumbnail"><i class="fa fa-user-secret"></i></span>
            <ul class="sub-menu">
              <li class="">
                <a href="{{url('administrador/rol.html')}}">Roles</a>
                <span class="icon-thumbnail">R</span>
              </li>
              <li class="">
                <a href="{{url('administrador/permiso.html')}}">Permisos</a>
                <span class="icon-thumbnail">P</span>
              </li>
              <li class="">
                <a href="{{url('administrador/seccion.html')}}">Sección</a>
                <span class="icon-thumbnail">Se</span>
              </li>
              <li class="">
                <a href="{{url('administrador/modulo.html')}}">Módulos</a>
                <span class="icon-thumbnail">M</span>
              </li>
            </ul>
          </li>
          <li>
            <a href="javascript:;"><span class="title">Idiomas</span>
            <span class=" arrow"></span></a>
            <span class="icon-thumbnail"><i class="fa fa-globe" aria-hidden="true"></i></span>
            <ul class="sub-menu">
              <li class="">
                <a href="{{url('administrador/idioma.html')}}">Idiomas</a>
                <span class="icon-thumbnail">I</span>
              </li>
              <li class="">
                <a href="{{url('administrador/idiomas/galeria.html')}}">Galería</a>
                <span class="icon-thumbnail">G</span>
              </li>
              <li class="">
                <a href="{{url('administrador/idiomas/menu.html')}}">Menú</a>
                <span class="icon-thumbnail">Me</span>
              </li>
              <li class="">
                <a href="{{url('administrador/idiomas/sitio.html')}}">Sitio</a>
          ...
          <li>
            ...
            <ul class="sub-menu">
              ...
              <li class="">
                <a href="{{url('cerrar.html')}}">Login</a>
                <span class="icon-thumbnail">l</span>
              </li>
              <li class="">
        ...
        <div class="container-fluid container-fixed-lg footer">
          <div class="copyright sm-text-center">
            <p class="small no-margin pull-left sm-pull-reset">
              ...
              <span class="font-montserrat">Abargon</span>.
